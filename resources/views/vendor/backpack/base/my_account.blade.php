        ...
        <div class="col-lg-8">
            ...
            <div class="col-md-4">
                ...
                <div class="card-body p-4">
                    ...
                    <ul>
                        <li>This is your default centre</li>
                        <li>You can change this one</li>
                    </ul>
                    <select id="default" data-url="{{route('centre-switch-default')}}">
                        @php
                        $userCentre = getCentreByAuthId();
                        $defaultCentre = getDefaultCentreByAuthId();
                        @endphp

                        @foreach($userCentre as $centre)
                            <option value="{{$centre->id}}" {{ ($centre->id == $defaultCentre->centre_id) ? 'selected' : '' }}>{{$centre->name}}</option>
                        @endforeach
                    </select>
                </div>
                    <div class="card-footer">
